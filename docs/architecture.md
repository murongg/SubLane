...
| `internal/gateway` | Bounded admission/account leases, durable cooldown, bounded request history, account affinity, quota snapshots, and per-request orchestration | Public management authorization |
