...
| `internal/allocations` | Personnel teams, exclusive-pool schemes, configuration revisions and per-scheme accounting | Provider network IO, browser authorization or billing |
