...
6. **Backup/restore implemented:** online SQLite snapshots, CLI and administrator web export/verification, isolated-directory recovery and explicit restart switching. Deployment release automation and a measured resource baseline remain. See [backup and restore](backup.md).
