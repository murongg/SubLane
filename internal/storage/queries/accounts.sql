...
VALUES (sqlc.arg(id), sqlc.arg(name), sqlc.arg(account_id), sqlc.arg(email), sqlc.arg(plan), 1, sqlc.arg(status), sqlc.arg(credential), sqlc.arg(expires_at), sqlc.arg(created_at), sqlc.arg(updated_at))
